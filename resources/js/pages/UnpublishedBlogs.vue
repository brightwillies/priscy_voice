                  ...
                  ">
                                ...
                                <tbody>
                                    <tr v-for="singleItem in tableData" :key="singleItem.id">
                                        ...
                                        <td>{{ singleItem.day }} {{ singleItem.mon }} {{ singleItem.year }}</td>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required v-model="form.title" type="text" id="name"
                                ...
                                <div class="col-lg-6 col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input required v-model="form.date" type="date" id="name"
                                            name="group-a[0][untyped-input]" class="form-control" />
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <textarea v-model="form.introduction" name="" id="" style="width: 100%"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <vue-editor useCustomImageHandler @image-added="handleImageAdded"
                                            v-model="form.summary" :editorToolbar="customToolbar"></vue-editor>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="example-text-input"
                                            class="col-md-3 col-form-label form-control-label">Preview</label>
                                        <div class="col-md-12">
                                            <img :src="imageAvatar" id="profile-img-tag" height="250px" width="100%" />

                                            <div class="custom-file">
                                                <input type="file" class="custom-file-input" id="customFileLang"
                                                    lang="en" @change="getFeaturedImage" ref="webfile" />
